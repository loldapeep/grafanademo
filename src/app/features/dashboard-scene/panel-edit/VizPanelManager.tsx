...
import { getPluginVersion } from '../../dashboard/state/PanelModel';
import { getLastUsedDatasourceFromStorage } from '../../dashboard/utils/dashboard';
import { storeLastUsedDataSourceInLocalStorage } from '../../datasources/components/picker/utils';
import { updateLibraryVizPanel } from '../../library-panels/state/api';
