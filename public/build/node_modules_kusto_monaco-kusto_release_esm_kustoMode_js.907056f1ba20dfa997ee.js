"use strict";
(self["webpackChunkgrafana"] = self["webpackChunkgrafana"] || []).push([["node_modules_kusto_monaco-kusto_release_esm_kustoMode_js"],{
...
/* harmony export */   getKustoWorker: () => (/* binding */ getKustoWorker),
/* harmony export */   setupMode: () => (/* binding */ setupMode)
/* harmony export */ });
/* harmony import */ var monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./node_modules/monaco-editor/esm/vs/editor/editor.api.js");
/* harmony import */ var _workerManager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./node_modules/@kusto/monaco-kusto/release/esm/workerManager.js");
/* harmony import */ var _languageServiceManager_kustoMonarchLanguageDefinition__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./node_modules/@kusto/monaco-kusto/release/esm/languageServiceManager/kustoMonarchLanguageDefinition.js");
/* harmony import */ var _languageFeatures__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./node_modules/@kusto/monaco-kusto/release/esm/languageFeatures.js");
...
function setupMode(defaults, monacoInstance) {
    var _this = this;
    var onSchemaChange = new monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_0__.Emitter();
    ...
    var client = new _workerManager__WEBPACK_IMPORTED_MODULE_1__.WorkerManager(monacoInstance, defaults);
    ...
    var language = 'kusto';
    disposables.push(monacoInstance.languages.registerCompletionItemProvider(language, new _languageFeatures__WEBPACK_IMPORTED_MODULE_3__.CompletionAdapter(workerAccessor, defaults.languageSettings)));
    ...
    if (defaults.languageSettings.useTokenColorization) {
        monarchTokensProvider = monacoInstance.languages.setMonarchTokensProvider(language, _languageServiceManager_kustoMonarchLanguageDefinition__WEBPACK_IMPORTED_MODULE_2__.KustoLanguageDefinition);
    }
    ...
    disposables.push(new _languageFeatures__WEBPACK_IMPORTED_MODULE_3__.DiagnosticsAdapter(monacoInstance, language, workerAccessor, defaults, onSchemaChange.event));
    disposables.push(new _languageFeatures__WEBPACK_IMPORTED_MODULE_3__.ColorizationAdapter(monacoInstance, language, workerAccessor, defaults, onSchemaChange.event));
    disposables.push(monacoInstance.languages.registerDocumentRangeFormattingEditProvider(language, new _languageFeatures__WEBPACK_IMPORTED_MODULE_3__.FormatAdapter(workerAccessor)));
    disposables.push(monacoInstance.languages.registerFoldingRangeProvider(language, new _languageFeatures__WEBPACK_IMPORTED_MODULE_3__.FoldingAdapter(workerAccessor)));
    disposables.push(monacoInstance.languages.registerDefinitionProvider(language, new _languageFeatures__WEBPACK_IMPORTED_MODULE_3__.DefinitionAdapter(workerAccessor)));
    disposables.push(monacoInstance.languages.registerRenameProvider(language, new _languageFeatures__WEBPACK_IMPORTED_MODULE_3__.RenameAdapter(workerAccessor)));
    disposables.push(monacoInstance.languages.registerReferenceProvider(language, new _languageFeatures__WEBPACK_IMPORTED_MODULE_3__.ReferenceAdapter(workerAccessor)));
    if (defaults.languageSettings.enableHover) {
        disposables.push(monacoInstance.languages.registerHoverProvider(language, new _languageFeatures__WEBPACK_IMPORTED_MODULE_3__.HoverAdapter(workerAccessor)));
    }
    monacoInstance.languages.registerDocumentFormattingEditProvider(language, new _languageFeatures__WEBPACK_IMPORTED_MODULE_3__.DocumentFormatAdapter(workerAccessor));
...
/***/ "./node_modules/@kusto/monaco-kusto/release/esm/languageFeatures.js":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ColorizationAdapter: () => (/* binding */ ColorizationAdapter),
...
/* harmony export */   DocumentFormatAdapter: () => (/* binding */ DocumentFormatAdapter),
/* harmony export */   FoldingAdapter: () => (/* binding */ FoldingAdapter),
...
/* harmony export */ });
/* harmony import */ var monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./node_modules/monaco-editor/esm/vs/editor/editor.api.js");
/* harmony import */ var vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./node_modules/vscode-languageserver-types/lib/esm/main.js");
/* harmony import */ var lodash_es_debounce__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./node_modules/lodash-es/debounce.js");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
var DiagnosticsAdapter = /** @class */ (function () {
    function DiagnosticsAdapter(_monacoInstance, _languageId, _worker, defaults, onSchemaChange) {
        ...
        if (this.defaults.languageSettings.enableQuickFixes) {
            this._disposables.push(monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_0__.languages.registerCodeActionProvider(this._languageId, {
    ...
    DiagnosticsAdapter.prototype.getOrCreateDebouncedValidation = function (model, languageId) {
        ...
        if (!this._debouncedValidations[modelUri]) {
            this._debouncedValidations[modelUri] = (0,lodash_es_debounce__WEBPACK_IMPORTED_MODULE_2__["default"])(function (intervals) { return _this._doValidate(model, languageId, intervals); }, 500);
        }
                        ...
                        return {
                            ...
                            options: {
                                ...
                                overviewRuler: {
                                    ...
                                    position: monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_0__.editor.OverviewRulerLane.Right,
                                },
                                minimap: {
                                    color: 'rgb(255, 18, 18, 0.7)',
                                    position: monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_0__.editor.MinimapPosition.Inline,
                                },
                            },
                        };
                    });
                    var oldMarkers = monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_0__.editor.getModelMarkers({
                        owner: languageId,
                        resource: resource,
                    });
...
function toSeverity(lsSeverity) {
    switch (lsSeverity) {
        case vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_1__.DiagnosticSeverity.Error:
            return monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_0__.MarkerSeverity.Error;
        case vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_1__.DiagnosticSeverity.Warning:
            return monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_0__.MarkerSeverity.Warning;
        case vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_1__.DiagnosticSeverity.Information:
            return monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_0__.MarkerSeverity.Info;
        case vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_1__.DiagnosticSeverity.Hint:
            return monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_0__.MarkerSeverity.Hint;
        default:
            return monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_0__.MarkerSeverity.Info;
    }
}
...
var ColorizationAdapter = /** @class */ (function () {
    function ColorizationAdapter(_monacoInstance, _languageId, _worker, defaults, onSchemaChange) {
        ...
        var onModelAdd = function (model) {
            ...
            var debouncedColorization = (0,lodash_es_debounce__WEBPACK_IMPORTED_MODULE_2__["default"])(function (intervals) { return _this._doColorization(model, languageId, intervals); }, 500);
            var handle;
...
function toDecoration(model, classification) {
    ...
    var range = new monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_0__.Range(start.lineNumber, start.column, end.lineNumber, end.column);
    var inlineClassName = ClassificationKindNames[classification.kind];
    return {
        range: range,
        options: {
            inlineClassName: inlineClassName,
            stickiness: monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_0__.editor.TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges,
        },
    };
}
// --- completion ------
...
function toRange(range) {
    ...
    return new monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_0__.Range(range.start.line + 1, range.start.character + 1, range.end.line + 1, range.end.character + 1);
}
function toCompletionItemKind(kind) {
    var mItemKind = monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_0__.languages.CompletionItemKind;
    switch (kind) {
        case vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_1__.CompletionItemKind.Text:
            return mItemKind.Text;
        case vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_1__.CompletionItemKind.Method:
            return mItemKind.Method;
        case vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_1__.CompletionItemKind.Function:
            return mItemKind.Function;
        case vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_1__.CompletionItemKind.Constructor:
            return mItemKind.Constructor;
        case vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_1__.CompletionItemKind.Field:
            return mItemKind.Field;
        case vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_1__.CompletionItemKind.Variable:
            return mItemKind.Variable;
        case vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_1__.CompletionItemKind.Class:
            return mItemKind.Class;
        case vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_1__.CompletionItemKind.Interface:
            return mItemKind.Interface;
        case vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_1__.CompletionItemKind.Module:
            return mItemKind.Module;
        case vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_1__.CompletionItemKind.Property:
            return mItemKind.Property;
        case vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_1__.CompletionItemKind.Unit:
            return mItemKind.Unit;
        case vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_1__.CompletionItemKind.Value:
            return mItemKind.Value;
        case vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_1__.CompletionItemKind.Enum:
            return mItemKind.Enum;
        case vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_1__.CompletionItemKind.Keyword:
            return mItemKind.Keyword;
        case vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_1__.CompletionItemKind.Snippet:
            return mItemKind.Snippet;
        case vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_1__.CompletionItemKind.Color:
            return mItemKind.Color;
        case vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_1__.CompletionItemKind.File:
            return mItemKind.File;
        case vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_1__.CompletionItemKind.Reference:
...
var CompletionAdapter = /** @class */ (function () {
    ...
    CompletionAdapter.prototype.provideCompletionItems = function (model, position, context, token) {
        ...
        var wordRange = new monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_0__.Range(position.lineNumber, wordInfo.startColumn, position.lineNumber, wordInfo.endColumn);
        var resource = model.uri;
        ...
        return this._worker(resource)
            ...
            var items = info.items.map(function (entry) {
                ...
                if (entry.insertTextFormat === vscode_languageserver_types__WEBPACK_IMPORTED_MODULE_1__.InsertTextFormat.Snippet) {
                    item.insertTextRules = monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_0__.languages.CompletionItemInsertTextRule.InsertAsSnippet;
                }
                return item;
            });
            return {
    ...
    CompletionAdapter.prototype.formatDocLink = function (docString) {
        ...
        var urisProxy = new Proxy({}, {
            get: function (_target, prop, _receiver) {
                ...
                var monacoUri = monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_0__.Uri.parse(url);
...
function toLocation(location) {
    return {
        uri: monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_0__.Uri.parse(location.uri),
...
function toWorkspaceEdit(edit) {
    ...
    for (var uri in edit.changes) {
        var _uri = monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_0__.Uri.parse(uri);
...
function toFoldingRange(range) {
    return {
        ...
        kind: monaco_editor_esm_vs_editor_editor_api__WEBPACK_IMPORTED_MODULE_0__.languages.FoldingRangeKind.Region,
    };
}
// --- hover ------
...
/***/ "./node_modules/@kusto/monaco-kusto/release/esm/languageServiceManager/kustoMonarchLanguageDefinition.js":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   KustoLanguageDefinition: () => (/* binding */ KustoLanguageDefinition)
/* harmony export */ });
...
/***/ "./node_modules/@kusto/monaco-kusto/release/esm/workerManager.js":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _now_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./node_modules/lodash-es/now.js");
...
//# sourceMappingURL=node_modules_kusto_monaco-kusto_release_esm_kustoMode_js.907056f1ba20dfa997ee.js.map